...
class ZoomablePreviewWidget(PreviewDocumentApiMixin, PreviewNavigationMixin, PreviewZoomMixin, PreviewSearchPanelMixin, PreviewThemeMixin, PreviewInteractionMixin, QWidget):
    ...
    def _setup_ui(self):
        ...
        # 전역 QPushButton padding(12/24)과 fixed size 충돌을 피하기 위해
        # toolbarIconBtn / toolbarBtn / toolbarSecondaryBtn 을 사용한다.
        self.btn_zoom_out = QPushButton("-")
        self.btn_zoom_out.setObjectName("toolbarIconBtn")
        self.btn_zoom_out.setToolTip(tm.get("tooltip_zoom_out"))
        ...
        self.btn_zoom_in.setObjectName("toolbarIconBtn")
        self.btn_zoom_in.setToolTip(tm.get("tooltip_zoom_in"))
        self.btn_zoom_in.clicked.connect(self._on_zoom_in)
        toolbar.addWidget(self.btn_zoom_in)

        self.btn_fit = QPushButton(tm.get("btn_fit_view"))
        self.btn_fit.setObjectName("toolbarBtn")
        ...
        self.btn_actual.setObjectName("toolbarBtn")
        ...
        self.btn_toggle_search.setObjectName("toolbarSecondaryBtn")
        ...
        self.btn_page_setup.setObjectName("toolbarSecondaryBtn")
        ...
        self.btn_print.setObjectName("toolbarSecondaryBtn")
        ...
        self.btn_prev.setObjectName("toolbarBtn")
        ...
        self.btn_next.setObjectName("toolbarBtn")
