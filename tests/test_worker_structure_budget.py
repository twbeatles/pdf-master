...
def test_legacy_shims_stay_thin_after_refactor():
    budgets = {
        ...
        "src/core/worker_ops/annotation/textbox.py": 60,  # thin facade (impl: textbox_impl/)
        "src/core/worker_ops/annotation/textbox_impl/__init__.py": 40,
        "src/core/worker_ops/annotation/textbox_impl/args.py": 120,
        "src/core/worker_ops/annotation/textbox_impl/base.py": 80,
        "src/core/worker_ops/annotation/textbox_impl/single.py": 120,
        "src/core/worker_ops/annotation/textbox_impl/batch.py": 140,
        "src/core/worker_ops/annotation/textbox_impl/replace.py": 120,
        "src/core/worker_ops/annotation/textbox_impl/extract.py": 100,
        "src/core/worker_ops/compare/ops.py": 240,  # orchestration facade (phases: text/visual/report)
        "src/core/worker_ops/compare/text_diff.py": 120,
        "src/core/worker_ops/compare/visual_diff.py": 140,
        "src/core/worker_ops/compare/report.py": 140,
        "src/core/worker_runtime/mixin.py": 60,  # thin facade (impl: mixin_* modules)
        "src/core/worker_runtime/mixin_payload.py": 60,
        "src/core/worker_runtime/mixin_progress.py": 120,
        "src/core/worker_runtime/mixin_files.py": 100,
        "src/core/worker_runtime/mixin_access.py": 140,
        "src/core/worker_runtime/mixin_run.py": 120,
